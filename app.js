        ...
        <div class="flex flex-col items-center w-full mb-8">
            ...
            <div class="details-hero w-full !flex-col !items-center !justify-center !pt-4 !pb-5 !px-6 !gap-0 text-center">
                ...
                <div class="details-hero-meta justify-center">
                    ...
                    ${album.totalTracks ? `<span>•</span><span>${album.totalTracks} faixas</span>` : ''}
                </div>
        ...
        <div class="flex flex-col items-center w-full mb-8">
            ...
            <div class="details-hero w-full !flex-col !items-center !justify-center !pt-4 !pb-5 !px-6 !gap-0 text-center">
                ...
                <div class="details-hero-meta justify-center">
                    ...
                    ${artist.worldRank > 0 ? `<span class="inline-flex items-center gap-1.5 text-white/80">
                        <svg class="w-4 h-4 text-emerald-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        #${artist.worldRank} no mundo
                    </span>` : ''}
                </div>
